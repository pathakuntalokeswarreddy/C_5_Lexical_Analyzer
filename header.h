...
static char *res_keywords[] = { "const", "volatile", "extern", "auto", "register", "static", 
                         ...
                         "struct", "enum", "union" ,"void", "typedef"}; //19

static char *non_res_keywords[] = { "if", "else", "switch", "case", "goto", "lable", "default",
                                    "break", "continue", "for", "do", "while", "return", "sizeof"}; //14

static char *directives[] = { "#include", "#define", "#if", "#endif", "#ifdef", "#ifndef", "#undef"}; //7

static char *compound_operators[] = { "==", "!=", "|=", "&=", "^=", "<=", ">=", "+=", "-=", "*=", "/=", "%=", 
                                     "<<", ">>", "++", "--"}; //16
static char operators[] = { '/', '*', '-', '+', '%', '=', '<', '>', '&', '!', '^', '|', '~', ','}; //14
static char symbol[]    = { '(', ')', '{', '}', '[', ']', ':'}; //7
